...
namespace Presentacion.Filters
{
    public class StandardResponseFilter : IActionFilter
    {
        ...
        public void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            {
                // Si el servicio ya devolvió BaseResponse, se respeta totalmente
                if (objectResult.Value is BaseResponse apiResponse)
                {
